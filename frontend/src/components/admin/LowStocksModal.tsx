...
const ALL_ITEMS: LowStockItem[] = [
  ...
  {
    id: 2,
    name: "Paracetamol 500MG Tab (BIOGESIC) 500's",
    classification: "Medicines Supplies",
    branch: "BMC MAIN",
...
export default function LowStocksModal({
  isOpen,
  onClose,
}: LowStocksModalProps) {
  ...
  function handleBulkReorder() {
    const names = filtered.filter((i) => selected.has(i.id)).map((i) => i.name);
    if (names.length === 0) {
      alert("Please select at least one item to reorder.");
    } else {
      alert(`Bulk reorder initiated for:\n• ${names.join("\n• ")}`);
    }
  }
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            <div
              ...
              style={{ background: "rgba(230,4,4,0.18)" }}
            >
              <AlertCircle size={20} style={{ color: "rgba(230,4,4,0.85)" }} />
            </div>
            <div>
              ...
              <p
                ...
                style={{ color: "rgba(193,227,255,0.75)" }}
              >
        ...
        >
          ...
          >
            ...
            <input
              ...
              className="bg-transparent outline-none text-sm placeholder-[rgba(233,232,232,0.6)] text-white flex-1 min-w-0"
            />
          </div>
                ...
                {[
                  ...
                  <th
                    ...
                    className={`px-4 py-2.5 font-semibold text-left whitespace-nowrap ${
                      ["Quantity", "Reorder", "Select"].includes(col)
                        ? "text-center"
                        : ""
                    }`}
                ...
                filtered.map((item, idx) => (
                  ...
                  >
                    ...
                    <td
                      ...
                      style={{ color: "#001d63", maxWidth: "240px" }}
                    >
                    ...
                    <td className="px-4 py-2.5 text-center">
                      <div className="flex items-center justify-center">
                        <input
                          ...
                          className="w-4 h-4 rounded cursor-pointer accent-[#1133f2]"
                          style={{ accentColor: "#1133f2" }}
                        />
                      </div>
                    </td>
                  </tr>
        ...
        >
          <p className="text-xs" style={{ color: "#636363" }}>
            ...
            items
            {selected.size > 0 && (
              <span className="ml-2" style={{ color: "#1133f2" }}>
